<template>
    <header class="text-gray-600 bg-white body-font border-b-2">
        <div
		...
		{links.map((link, index) => (
            ...
            <div class="flex">
                <div class="mr-5 py-4 px-6 hidden lg:block">
                    <a
                        class="github-button"
